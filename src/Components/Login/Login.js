...
<form onSubmit={handleSubmit}>
  <div class="container">
    ...
    {newUser && <input type="text" onBlur={handleBlur} placeholder="Enter Name" name="name" id="name" required />
     }
    <input type="text" onBlur={handleBlur} placeholder="Enter Email" name="email" id="email" required />
    <input type="password" onBlur={handleBlur} placeholder="Enter Password" name="password" id="psw" required />
   {newUser &&  <input type="password" onBlur={handleBlur} placeholder="Confrim Password" name="confirmPassword" id="psw-repeat" required />
   } 
  ...
  <div class="container signin">
    <p>Already have an account? <a href={'/directLogin'}>Login</a>.</p>
  </div>
  <div class="container">
